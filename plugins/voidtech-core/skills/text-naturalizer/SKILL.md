...
description: 润色中文、英文或中英混排文本，在保留含义、事实、作者语气和专业风格的前提下减少常见 AI 写作痕迹。适用于文章、文档、邮件、PR 描述、产品文案和双语草稿。
---
...
本 skill 重新组织并改写了以下 MIT 项目的思路：`blader/humanizer` 与 `op7418/Humanizer-zh`。详细许可证见 [LICENSE](LICENSE)。
