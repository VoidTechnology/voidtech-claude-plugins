---
name: plan-review-docs
description: 逐项检查方案或设计，并同步整理 ADR 与业务词汇表。
...
调用 `voidtech-core:plan-review-core` 技能逐项检查方案，并配合 `voidtech-engineering:feature-context` 技能同步整理文档。
