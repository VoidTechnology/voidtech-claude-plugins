...
| 流程 | 步骤ID | 交互ID | 业务对象 | 当前状态 | 下一状态 | 依赖模块/系统 | 失败传播 | 需求编号 |
|---|---|---|---|---|---|---|---|---|
| 查看客户详情 | S1 | I2 | 客户 | 待激活 | 已激活 | 02-module-b | 依赖不可用时阻断并提示 | TST-001 |

### 5.0.3 页面交互（机器可解析）

| 流程 | 步骤ID | 交互ID | 页面 | 容器/状态 | 控件 | 事件 | 可用条件 | 即时反馈 | 系统动作 | 成功结果 | 失败与恢复 | 下一交互 | 需求编号 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 查看客户详情 | S1 | I1 | 客户列表页 | 列表 | 无 | 进入 | 已登录 | 显示骨架屏 | 读取客户列表 | 展示客户列表 | 加载失败时提示重试 | I2 | TST-001 |
| 查看客户详情 | S1 | I2 | 客户列表页 | 列表 | 客户行 | 点击 | 客户存在 | 高亮所选客户 | 读取客户详情 | 打开客户详情 | 客户不存在时提示并保留列表 | 结束 | TST-001~003 |
| 查看客户详情 | S2 | I1 | 客户详情页 | 详情 | 无 | 进入 | 客户存在 | 显示详情骨架 | 读取客户资料 | 展示客户资料 | 客户已删除时返回列表 | 结束 | TST-003 |

### 5.1 查看客户详情

**边缘状态**

| 步骤ID | 交互ID | 页面 | 状态 | 触发条件 | 系统行为 | 用户可执行操作 | 验收要点 |
|---|---|---|---|---|---|---|---|
