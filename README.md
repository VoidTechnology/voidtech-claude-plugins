...
| 插件 | 版本 | 默认 | 内容 |
|---|---|---|---|
| [`voidtech-core`](plugins/voidtech-core) | 0.18.0 | ✅ 启用 | 中文约定 + 8 个公共技能 + 共享 Archify Runtime |
| [`voidtech-product`](plugins/voidtech-product) | 0.1.0 | ✅ 启用 | 模块化 PRD、需求同步、产品验收 + Product Manager subagent |
