...
`Claude Code ≥ 2.1.154` · `voidtech-core v0.8.3` · 内部分发
...
| 插件 | 版本 | 默认 | 内容 |
|---|---|---|---|
| [`voidtech-core`](plugins/voidtech-core) | 0.8.3 | ✅ 启用 | 中文约定 + 22 个自包含工程技能 |
...
- **调研、规划与设计** — `research`、`feature-context`、`codebase-design`、`to-prd`、`to-issues`、`prepare-issue`、`plan-review`、`plan-review-docs`
