...
`Claude Code ≥ 2.1.154` · `voidtech-core v0.11.1` · 内部分发
...
/voidtech-core:prd-from-requirements  从原始需求生成模块化 PRD 工作树
...
| 插件 | 版本 | 默认 | 内容 |
|---|---|---|---|
| [`voidtech-core`](plugins/voidtech-core) | 0.11.1 | ✅ 启用 | 中文约定 + 25 个自包含工程技能 + 2 个专业 subagent |
