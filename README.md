...
`voidtech-core v0.20.0` · `voidtech-product v0.7.0` · `voidtech-design/engineering v0.2.0` · `voidtech-loop v0.3.0` · Claude Code ≥ 2.1.154（loop ≥ 2.1.210，review ≥ 2.1.211） · OMP ≥ 17.1.5 · Apache-2.0
...
| [`voidtech-product`](plugins/voidtech-product) | 0.7.0 | ✅ 启用 | 模块化 PRD、需求同步、Logic Atlas 阅读与产品验收 + Product Manager subagent |
